...
var fala_index = 0
var falas = [
	"Seu Miserável conseguiu chegar até aqui...",
	"Falando logo para você que iremos destruir esse vilarejo...",
	"Estamos vendo que os seres desta terra estão completamente egoístas...",
	"Se quiser me impedir terá que me derrotar ...",
	"Vou acabar com você!"
]
