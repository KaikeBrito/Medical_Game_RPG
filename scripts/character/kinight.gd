...
var fala_index = 0
var falas = [
	"Kuaray, seis invasores profanaram nossas casas ancestrais.",
	"Sua missão é clara: invada cada lar, derrote aqueles que se apossaram dele e recupere os Símbolos de Proteção.",
	"Só assim enfraquecerás sua maldição e devolverás a luz a Tiwahan. Vá com coragem e honra."
]
