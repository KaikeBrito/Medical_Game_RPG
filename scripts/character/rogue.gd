...
var fala_index = 0
var falas = [
	"Floresta fraca, povo fraco. Só sobreviverá o mais forte… e esse sou eu.",
	"Você luta com raízes e folhas? Eu corto árvores com os dentes.",
	"Te esmagarei como se fosses um inseto no caule!"
]
